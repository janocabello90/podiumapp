        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-10 space-y-8 text-sm text-gray-700 leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <p className="text-xs text-gray-500 italic">
              Datos registrales: pendientes de incorporar.
            </p>
            <p>El presente Aviso Legal se encuentra redactado en idioma castellano.</p>
          </section>

          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-gray-900">Condiciones de Uso</h2>
            <p>
              Se informa a la persona usuaria de la presente plataforma que el acceso a la misma supone la
              aceptación plena y sin reservas de todas y cada una de las condiciones incluidas en el presente
              Aviso Legal, siendo igualmente de aplicación y según el caso la correspondiente normativa legal
              de obligado cumplimiento. En caso de no estar de acuerdo con alguna de las condiciones aquí
              establecidas, la persona usuaria deberá abstenerse de utilizar la plataforma.
            </p>
            <p>
              La persona usuaria se compromete a la utilización de la plataforma de conformidad con la ley,
              la moral, las buenas costumbres generalmente aceptadas y el orden público. Asimismo, se obliga
              a no utilizar la plataforma con fines ilícitos, contrarios a lo establecido en este Aviso Legal,
              lesivos de los derechos e intereses de terceros, o que de cualquier forma puedan dañar, inutilizar,
              sobrecargar o deteriorar el sitio web o impedir la normal utilización o disfrute del mismo por
              parte de otras personas usuarias.
            </p>
            <p>
            ...
            <p>
              La persona usuaria utilizará la plataforma de forma diligente y asumiendo cualquier responsabilidad
              que pudiera derivarse al incumplir las condiciones incluidas en el presente Aviso Legal.
            </p>
            <p>
              La persona usuaria no podrá utilizar la plataforma para transmitir, almacenar, divulgar, promover
              o distribuir datos o contenidos que sean portadores de virus o cualquier otro código informático,
              archivos o programas diseñados para interrumpir, destruir o perjudicar el funcionamiento de cualquier
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-semibold text-gray-900">Propiedad Industrial e Intelectual</h2>
            <p>
          ...
          <section className="space-y-3">
            ...
            <p>
              ...
              Aviso Legal para estar informada de las actualizaciones que puedan realizarse.
            </p>
            <p>
