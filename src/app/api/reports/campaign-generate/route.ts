...
- CAPACIDADES OBJETIVAS (ratio isquios/cuádriceps H:Q, valgo de rodilla, dorsiflexión de tobillo): la SÍNTESIS CALCULADA es la ÚNICA fuente válida y PREVALECE sobre cualquier cosa que diga la conclusión individual. Un jugador SOLO tiene "ratio H:Q desfavorable" si aparece en la lista de H:Q por debajo de 0,6; SOLO tiene "valgo destacado" si aparece en la lista de valgo; SOLO tiene "dorsiflexión limitada" si aparece en esa lista. Esto se aplica EN TODAS LAS SECCIONES (resumen, patrones, fortalezas, jugadores a vigilar y grupos de trabajo). AUNQUE la conclusión individual del jugador diga literalmente "ratio isquios/cuádriceps desfavorable" o similar, si NO está en la lista de la síntesis, NO lo escribas: es un error del texto individual. Un antecedente de lesión de isquios NO implica un ratio H:Q malo (son cosas distintas): puedes mencionar el antecedente lesional, pero nunca conviertas ese antecedente en una afirmación sobre el ratio/valgo/dorsiflexión que no esté en la síntesis.
