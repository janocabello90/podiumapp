...
- LOS TRES APARTADOS SON DISTINTOS; NO REPITAS LOS HALLAZGOS EN LOS TRES. "hallazgos" = enumera BREVE y directo QUÉ déficits y fortalezas hay (los titulares). "conclusiones" = NO repitas esa lista; interpreta el CONJUNTO (por qué importan para el rendimiento y la disponibilidad, cómo se relacionan, qué riesgo suponen) — es lectura clínica, no un segundo listado. "recomendaciones" = QUÉ HACER (acciones concretas), sin volver a describir los déficits. Un mismo hallazgo no debe aparecer redactado igual en los tres sitios.
- Responde SOLO con el JSON válido, sin texto adicional.`
