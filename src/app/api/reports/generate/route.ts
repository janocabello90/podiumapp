...
- CIFRAS: MUY POCAS Y NUNCA ENTRE PARÉNTESIS. Usa solo las cifras CLAVE de lo prioritario (orientativamente 4-6 en todo el informe); el resto descríbelo en palabras sin número (ya están en el PDF de VALD). Cuando uses una cifra, INTÉGRALA en la frase, nunca entre paréntesis: "una asimetría del 37 %", NO "asimetría marcada (37 %)". Evita paréntesis con datos como "(92°/94°, asimetría 2 %)".
...

{
  ...
  "conclusiones": "Síntesis final integrada (2-3 párrafos), en prosa y SIN epígrafes ni listas. Interpreta el conjunto (cómo se mueve, cómo produce fuerza, cómo absorbe/genera carga), identifica los principales déficits y fortalezas con impacto en rendimiento y prevención, y CIERRA integrando el nivel y las áreas de riesgo funcional y el objetivo principal de trabajo para la temporada. Es la ÚNICA sección de síntesis del informe (no hay apartado de hallazgos aparte): debe bastarse por sí sola.",
  "recomendaciones": {
...
- COHERENCIA ANATÓMICA (¡importante!): no confundas regiones. «Tren superior» = hombro, codo, muñeca y columna dorsal; «tren inferior» = cadera, rodilla y tobillo. No atribuyas a una región hallazgos que pertenecen a otra; revisa CADA afirmación de "conclusiones" antes de cerrarla (p. ej., no cierres un párrafo sobre rodilla/cadera hablando de "tren superior").
- CIFRAS: MUY POCAS Y NUNCA ENTRE PARÉNTESIS. (a) Usa solo las asimetrías y percentiles de los hallazgos PRIORITARIOS —orientativamente entre 4 y 6 cifras en TODO el informe—; el resto descríbelo en palabras ("marcada", "baja", "conservada", "ligera") sin número, porque ya están en el anexo de VALD. (b) Cuando uses una cifra, INTÉGRALA en la frase: escribe "una asimetría del 37 % a favor de la derecha", NUNCA "asimetría marcada (37 %)". PROHIBIDO acumular datos entre paréntesis del tipo "(92°/94°, asimetría 2 %)" o "(percentil 27)": esos paréntesis con cifras no deben aparecer.
...
- CONCLUSIONES Y RECOMENDACIONES SON DISTINTAS Y NO SE REPITEN. "conclusiones" = QUÉ ocurre y POR QUÉ importa (lectura clínica del conjunto: déficits, fortalezas, riesgo y objetivo). "recomendaciones" = QUÉ HACER (acciones concretas), SIN volver a describir los déficits ya explicados en conclusiones.
- Responde SOLO con el JSON válido, sin texto adicional.`
